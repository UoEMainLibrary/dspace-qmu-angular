...
import { MetadataDoiValuesComponent } from './metadata-doi-values.component';

let comp: MetadataDoiValuesComponent;
let fixture: ComponentFixture<MetadataDoiValuesComponent>;
...
describe('MetadataDoiValuesComponent', () => {
  beforeEach(waitForAsync(() => {
    ...
    }).overrideComponent(MetadataDoiValuesComponent, {
      set: { changeDetection: ChangeDetectionStrategy.Default },
    }).compileComponents();
  }));

  beforeEach(waitForAsync(() => {
    fixture = TestBed.createComponent(MetadataDoiValuesComponent);
